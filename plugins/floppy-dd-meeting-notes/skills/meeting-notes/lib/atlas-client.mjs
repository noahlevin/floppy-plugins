/**
 * Thin REST client for the Atlas agent mirror used by the deterministic
 * meeting-notes CLI fallback.
 *
 * The live Claude Code skill path uses MCP tools directly. This client exists
 * only so `bin/run.mjs` can prepare review-required drafts without an LLM or
 * ClickUp writes.
 */
...
export const createAtlasClient = (options) => {
  ...
  return {
    /**
     * Call the Atlas Brief REST mirror.
